...
export function generateQuizPrompt(params: PromptParams): string {
    const { language, notes, videoTranscription, minQuestions, maxQuestions } =
        params
    ...
    const prompt = `Our USER want you to generate an educational quiz from youtube video transcription with the following specifications:
