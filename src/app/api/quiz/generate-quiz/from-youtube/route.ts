...
const COST = Number(process.env.NEXT_PUBLIC_HIGH_CREDIT_COST)
...
export async function POST(req: NextRequest) {
    try {
        ...
        const prompt = generateQuizPrompt({
            ...
            minQuestions,
            maxQuestions,
            videoTranscription: videoTranscription.join(" "),
        })
        ...
        const llmResponse = streamText({
            ...
            RULES :
                ...
                - Do not mention the youtube video transcription given to you by the user.
                - Your answer should start with this character "{".
                - Never mention that you are basing the quiz from youtube video transcription.
...
export type GenerateQuizBodyFromYoutubeType = z.infer<typeof bodySchema>
