...
import { getEditUserPrompt, getEditMindMapPrompt } from "./prompt"
...
export async function POST(req: NextRequest) {
    try {
        ...
        const prompt = getEditUserPrompt(data)
...
const bodySchema = z.object({
    originalMindmap: z.string(),
    editInstructions: z.string(),
    language: z.string().optional().nullable(),
})

export type TEditMindMap = z.infer<typeof bodySchema>
