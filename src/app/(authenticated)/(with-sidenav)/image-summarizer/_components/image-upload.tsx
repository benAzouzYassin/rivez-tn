    ...
    return (
        <div className="w-full max-w-3xl pt-28 space-y-6">
            ...
            >
                ...
                >
                    <div className="w-20 h-20 bg-blue-50 dark:bg-blue-950 rounded-full flex items-center justify-center mb-4">
                    ...
                    <p className="text-sm font-semibold text-neutral-500 dark:text-neutral-400 text-center mb-2">
