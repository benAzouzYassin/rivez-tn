...
export default function Answer(props: Props) {
    ...
    return (
        <div
            className={cn(
                "w-[32rem] flex flex-col pt-10 relative h-[32rem] border-2 rounded-2xl border-neutral-300 border-dashed",
                props.className
            )}
        >
            <div className="flex items-center h-44 justify-center mb-8"></div>
