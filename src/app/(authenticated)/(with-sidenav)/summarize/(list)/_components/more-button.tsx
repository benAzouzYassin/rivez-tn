...
import { deleteSummarizationById } from "@/data-access/summarize/delete"
            ...
            <>
                    ...
                    items={[
                        {
                            ...
                            label: t["Details"],
                            onClick: () =>
                                router.push(`/summarize/${props.itemId}`),
                        },
                        {
                ...
                <WarningDialog
                    ...
                    onConfirm={async () => {
                        ...
                        deleteSummarizationById(props.itemId)
                            .then((res) => {
                                queryClient.refetchQueries({
                                    predicate: (q) =>
                                        q.queryKey.includes("summarizations"),
                                })
