    ...
    return (
        ...
        >
            <div className="xl:w-[360px] w-0 h-[95vh] overflow-y-hidden fixed pb-20 bg-white dark:bg-neutral-900 transition-colors">
                <ScrollArea
                    className="w-full scale-x-[-1] xl:block 
hidden h-[95vh] -mt-1 border border-neutral-200 dark:border-neutral-700 overflow-y-auto py-4 bg-white dark:bg-neutral-900 transition-colors"
                >
