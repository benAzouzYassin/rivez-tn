...
export default function PagesViewer(props: Props) {
    ...
    function ShadowFileItem() {
        return (
            <div
                className={cn(
                    "h-16 mt-3 transition-all animate-pulse cursor-not-allowed flex border border-neutral-200 dark:border-neutral-700 text-lg from-neutral-100 text-[#545454] dark:text-neutral-400 hover:bg-neutral-100 dark:hover:bg-neutral-800 font-extrabold rounded-xl shadow-none w-full justify-start px-4 bg-white dark:bg-neutral-900"
                )}
            >
