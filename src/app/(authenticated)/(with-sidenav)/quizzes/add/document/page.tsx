...
export default function Document() {
    const translation = useMemo(
        () => ({
            ...
            fr: {
                generateFromPdf: "Générer à partir d'un PDF",
                goBack: "Retourner",
            ...
            ar: {
                generateFromPdf: "إنشاء من ملف PDF",
                goBack: "عودة",
    ...
    return (
        <main className="flex relative items-center pb-20 flex-col bg-white dark:bg-neutral-900 transition-colors min-h-screen">
            <h1 className="md:mt-10 mt-20 text-neutral-600 dark:text-neutral-200 text-3xl font-extrabold">
                {t.generateFromPdf}
            </h1>
            ...
            <section className="flex flex-col md:px-0 px-3 w-full mt-8 gap-1 max-w-[900px]">
                <Input
                    {...form.register("name")}
                ...
                <div className="grid mt-4 md:grid-cols-2 md:gap-8">
                    <Input
