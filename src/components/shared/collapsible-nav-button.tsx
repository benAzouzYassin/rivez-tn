        ...
        <Collapsible className="group" open={isOpen} onOpenChange={setIsOpen}>
            <CollapsibleTrigger asChild className="group">
                <Button
                    ...
                    variant="secondary"
                    className={cn(
                        "py-7 text-base  bg-white rtl:flex-row-reverse relative text-[#545454] hover:bg-neutral-100 border-white font-extrabold rounded-xl shadow-none w-full justify-start",
