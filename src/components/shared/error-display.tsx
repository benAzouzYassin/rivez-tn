        ...
        >
            <div className="text-center p-8 w-[50vw] h-[50vh] rounded-2xl  animate-fadeIn">
                ...
                <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
                    <Button
                        className="text-red-500 px-10 shadow-red-200 border-red-200"
                        onClick={() => router.back()}
                        variant={"secondary"}
                        type="button"
                    >
                    ...
                    <Button
                        variant={"red"}
                        className="text-white px-10 bg-red-500/90 shadow-red-600/70 border-red-600/70"
                        onClick={onRetry}
                        type="button"
                    >
                        <span className="translate-x-1">Retry</span>
                        <svg
