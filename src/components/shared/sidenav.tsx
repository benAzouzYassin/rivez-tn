    ...
    return (
        ...
        >
            <Button
                ...
                variant="outline"
                className={cn(
                    "absolute scale-100 active:scale-95 ltr:-right-4 rtl:-left-4 dark:bg-blue-600/70 dark:border-blue-600/50 bg-[#4e7bf5] hover:bg-[#467ffa] hover:cursor-pointer group-hover:opacity-100 border-2 duration-300 border-[#4676fa] opacity-0 top-6 !p-1 h-fit rounded-full w-fit"
                )}
            >
                {isSidenavOpen ? (
            ...
            <div className="absolute border-t bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-800 bottom-0 pt-6 pb-10 px-3 inset-inline-start-0 w-full transition-colors">
                <NavButton
