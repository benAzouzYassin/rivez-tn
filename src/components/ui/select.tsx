    ...
    <div>
        <SelectPrimitive.Trigger
            ...
            className={cn(
                ...
                "dark:focus:border-blue-600/30 dark:focus:ring-blue-800/50 dark:bg-neutral-800 dark:placeholder:text-neutral-500 dark:border-neutral-700 dark:text-neutral-200 dark:hover:bg-neutral-700",
    ...
    <SelectPrimitive.Portal>
        <SelectPrimitive.Content
            ...
            className={cn(
                ...
                position === "popper" &&
                    "data-[side=bottom]:translate-y-1 dark:bg-neutral-800 dark:text-neutral-200 dark:border-neutral-700 data-[side=left]:-translate-x-1 data-[side=right]:translate-x-1 data-[side=top]:-translate-y-1",
...
>(({ className, children, isDarkMode, ...props }, ref) => (
    <SelectPrimitive.Item
        ...
        className={cn(
            ...
            // Light mode styles
            {
                "shadow-neutral-200 dark:shadow-neutral-700 dark:hover:bg-blue-800/40 dark:focus:bg-blue-800/40 dark:focus:text-neutral-100 hover:bg-sky-200/70 focus:bg-sky-200/70 focus:text-neutral-900":
                    !isDarkMode,
            },
            // Dark mode styles
