...
const buttonVariants = cva(
    "inline-flex items-center hover:cursor-pointer   justify-center gap-2 whitespace-nowrap rounded-md border-[#E5E5E5] font-bold transition-all focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
    {
        variants: {
            variant: {
                blue: "bg-[#3593ff] h-[44px]    hover:bg-blue-500  shadow-[0px_4px_0px_0px] shadow-[#258dbe]  rounded-2xl text-white   transition-all  active:shadow-transparent active:translate-y-1",
                ...
                default:
                    " bg-neutral-800  text-white/95  hover:bg-neutral-700 h-[46px]  shadow-[0px_4px_0px_0px] shadow-neutral-500  rounded-2xl  border-2   transition-all  active:shadow-transparent active:translate-y-1 border-neutral-500 ",
                destructive:
            ...
            size: {
                default: "md:text-sm px-5 text-xs ",
