...
import { TGenMindMapFromImages } from "@/app/api/mindmap/generate/from-images/route"
import { TGenMindMapFromYoutube } from "@/app/api/mindmap/generate/from-youtube/route"
...
export const generateMindMapFromImages = async (
    data: TGenMindMapFromImages,
    onChange: (newValue: TGeneratedMindmap) => void,
    onFinish?: () => void
) => {
    const {
    ...
    const response = await fetch("/api/mindmap/generate/from-images", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
            "access-token": session.access_token,
...
export const generateMindMapFromYoutube = async (
    data: TGenMindMapFromYoutube,
    onChange: (newValue: TGeneratedMindmap) => void,
    onFinish?: () => void
) => {
    const {
    ...
    const response = await fetch("/api/mindmap/generate/from-youtube", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
            "access-token": session.access_token,
